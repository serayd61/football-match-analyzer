...
export default function LoginPage() {
  ...
  const labels = {
    tr: {
      ...
      features: ['Günün tahminleri: 1X2, üst/alt 2,5, karşılıklı gol', 'Yeni hesaba 7 gün tam erişim, kart gerekmez; sonra aylık plan', 'Ücretli planda değer radarı: modelin bahisçiden ayrıştığı maçlar', 'Karne herkese açık: isabet, kalibrasyon, kapanış oranına karşı getiri'],
    ...
    en: {
      ...
      features: ["The day's predictions: 1X2, over/under 2.5, both teams to score", 'New accounts get 7 days of full access, no card; then the monthly plan', 'Paid plan: value radar, the matches where the model disagrees with the bookmaker', 'Public record: hit rate, calibration, return against closing odds'],
    ...
    de: {
      ...
      features: ['Prognosen des Tages: 1X2, Über/Unter 2,5, beide treffen', 'Neue Konten: 7 Tage voller Zugang ohne Karte; danach der Monatsplan', 'Bezahlplan: Value-Radar mit den Spielen, bei denen das Modell vom Buchmacher abweicht', 'Öffentliche Bilanz: Trefferquote, Kalibrierung, Rendite gegen die Schlussquote'],
