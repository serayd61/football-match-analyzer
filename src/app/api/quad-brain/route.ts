    ...
    if (result.success && result.consensus) {
      ...
      try {
        ...
        await savePredictionSession({
          ...
          best_bet_1_market: result.bestBets?.[0]?.market || undefined,
          best_bet_1_selection: result.bestBets?.[0]?.selection || undefined,
          best_bet_1_confidence: result.bestBets?.[0]?.confidence || undefined,
          best_bet_2_market: result.bestBets?.[1]?.market || undefined,
          best_bet_2_selection: result.bestBets?.[1]?.selection || undefined,
          best_bet_2_confidence: result.bestBets?.[1]?.confidence || undefined,
          best_bet_3_market: result.bestBets?.[2]?.market || undefined,
          best_bet_3_selection: result.bestBets?.[2]?.selection || undefined,
          best_bet_3_confidence: result.bestBets?.[2]?.confidence || undefined,
